...
class AddActionActivity : ComponentActivity() {
        ...
        Column(
            ...
            Button(onClick = {
                val myAction = MyAction(
                    ...
                    cpf.value,
                    city.value,
                    isActive = toggleState.value // Pass toggle value to isActive property
                )
                ...
                if (name.value.isNotEmpty() && city.value.isNotEmpty()) {
                    if (selectedImageUri.value != null) {
                        ...
                        viewModel.insertAction(myAction)
                        (context as? Activity)?.onBackPressed()
                    } else {
                    ...
                    Toast.makeText(context, "Please give all inputs", Toast.LENGTH_SHORT)
                        .show()
                }
            }) {
                Text("Save")
